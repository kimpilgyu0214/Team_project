        ...
        <section class="page" id="page1"></section>
            ...
            <div class="map_wrap">
                <div class="map" id="map1">
                    <div class="map_img"><img src="${hpath }/images/map_tour_kor.jpg" alt=""></div>
                    <div class="map_text">
                        <h3>전주 여행지도</h3>
                ...
                <div class="map" id="map2">
                    <div class="map_img"><img src="${hpath }/images/map_food_kor.jpg" alt=""></div>
                    <div class="map_text">
                        <h3>전주 음식지도</h3>
            ...
            <div class="map_wrap">
                <div class="map" id="map3">
                    <div class="map" id="map1">
                        <div class="map_img2"><img src="${hpath }/images/map_hanok.jpg" alt=""></div>
                        <div class="map_text">
                            <h3>한옥마을 지도</h3>
                ...
                <div class="map" id="map4">
                    <div class="map" id="map1">
                        <div class="map_img2"><img src="${hpath }/images/map_ex.jpg" alt=""></div>
                        <div class="map_text">
                            <h3>한옥마을 체험지도</h3>
            ...
            <div class="map_wrap">
                <div class="map" id="map3">
                    <div class="map" id="map1">
                        <div class="map_img2"><img src="${hpath }/images/map_cycle.jpg" alt=""></div>
                        <div class="map_text">
                            <h3>전주 자전거길 지도</h3>
                            <p>전주 자전거길 지도</p>
                        </div>
                ...
                <div class="map" id="map4">
                    <div class="map" id="map1">
                        <div class="map_img2"><img src="${hpath }/images/map_walk.jpg" alt=""></div>
                        <div class="map_text">
                            <h3>전주 도보여행 지도</h3>
                            <p>사드락사드락 걸어서
                                전주도보여행 지도</p>
