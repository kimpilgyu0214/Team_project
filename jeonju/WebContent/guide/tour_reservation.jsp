...
<div id="content">
	...
	<div id="line"></div>
	    ...
	    <div class="content" id="page1">
	        ...
	        <form action="${hpath}/mypage/reservationConfirm.jsp" method="post">
	            <ul class="form_wrap">
	                <li>
	                    <div><label for="name"> 이름</label></div>
	                    <div><input type="text" name="name" id="name" readonly value=${name } ></div>
	                </li>
	                <li>
	                    <div><label for="phoneNumber"> 연락처</label></div>
	                    <div><input type="text" name="phoneNumber" id="phoneNumber" readonly value=${phoneNumber } ></div>
	                </li>
	                <li>
	                    <div><label for="email"> 이메일</label></div>
	                    <div><input type="text" name="email" id="email" readonly value=${email } ></div>
	                </li>
	                <li>
	            ...
	            <div class="button_group">
				    <button type="button" class="button" id="cancel" onclick="location.href='${ hpath}/guide/tourguide.jsp'">취소</button>
