...
#right_image_wrap { width: 800px; height: 600px; display: flex; justify-content: space-between; align-items: center; position: relative; flex-direction: column;
    background-image: url(${ hpath}/images/drew-bae-TWskAX7I0JU-unsplash.jpg); background-repeat: no-repeat; background-size: auto 100% ;  overflow: hidden; margin-right: 80px;}
