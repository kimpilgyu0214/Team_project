...
<%@ include file="/header.jsp" %>
	<div id="content">
	     ...
	     <div class="page_head">
	         ...
	         <div class="imgwrap">
	             <img src="${hpath }/images/market_chungnyun_03_head_upscayl_4x_realesrgan-x4plus.png" alt="청년몰">
	         </div>
	     </div>
	     
	     <section class="content_wrap">
	         <div class="content" id="page1">
	             <div class="img_left"><img src="${hpath }/images/market_chungnyun_01.jpg" alt="청년몰"></div>   
	             <div class="mall_text">
	         ...
	         <div class="content" id="page2">
	             ...
	             <div class="img_right"><img src="${hpath }/images/market_chungnyun_02-1.jpg" alt="청년몰"></div>
	             
	         </div>
	
	         <div class="content" id="page3">
	             <div class="img_left"><img src="${hpath }/images/market_chungnyun_03.jpg" alt="청년몰"></div>
	             <div class="mall_text">
